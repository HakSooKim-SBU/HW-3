...
export const SORT_BY_COLUMN = gql`
	mutation SortByColumn($_id: String!, $direction: [Int]) {
		sortByColumn(_id: $_id, direction: $direction ){
			_id
			id
			description
			due_date
...
export const CHANGE_TODOLISTS_TOP = gql`
	mutation ChangeTodolistsTop($new_id: String) {
		changeTodolistsTop(new_id: $new_id)	
	}
`;
